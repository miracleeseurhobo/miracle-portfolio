      ...
      <ol className="border-t border-white/[0.06]">
        {ROLES.map((r, i) => (
          ...
          >
            ...
            <div className="w-10 h-10 shrink-0 rounded-2xl bg-background border border-white/[0.09] flex items-center justify-center overflow-hidden">
              {r.logo ? (
                <img
                  src={r.logo}
                  alt={r.company}
            ...
            <div>
              <div className="flex items-center justify-between gap-4 mb-2">
                ...
                <span className="text-[16px] text-muted-foreground leading-snug tracking-[-0.008em] shrink-0">
                  {r.period}
                </span>
              </div>
